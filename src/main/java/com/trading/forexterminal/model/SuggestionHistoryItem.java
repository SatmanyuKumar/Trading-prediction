...
public class SuggestionHistoryItem {
    ...
    public SuggestionHistoryItem() {}

    public SuggestionHistoryItem(String id, String symbol, String timeframe, String mode, String signal,
                                 double entryPrice, double stopLoss, double takeProfit, double riskRewardRatio,
                                 int confidence, String triggerState, long suggestedTime) {
        this.id = id;
        this.symbol = symbol;
